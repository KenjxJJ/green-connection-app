  ...
  return (
    <>
      {productsInfo.map((product) => (
        <section className="border shadow rounded p-4 m-3">
          <header className=" d-flex justify-content-between px-3">
            ...
            <span className="font-weight-normal">
              Expected Arrival : {product.dateOfArrival}
              <br />
              Price (UGX) :{" "}
              <span className="font-weight-bold">{numberFormat(product.price)}</span>
            </span>
          </header>
