      ...
      {isDoneLoading ? (
        <>
          <section className="my-1">
            ...
            <header className="w-100 all-products-section px-5 py-5 my-n1">
              <h3 className="my-3 px-5"> All products </h3>
              <p className="lead px-5">
                Here is the list of all items we can bring close to you! Select
                to see the details and then order today!
              </p>
            </header>
            <main className="px-3 d-md-flex justify-content-between">
              <div className="py-3 w-lg-75 d-md-flex flex-wrap">
                {productsInfo.map((product) => (
                  <>
                    <Card
                      className="w-md-75 shadow my-2 m-md-4"
                      key={product.id}
                    >
                      <CardBody>
                        <CardTitle tag="h5">
